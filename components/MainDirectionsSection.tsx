...
const MainDirectionsSection = ({ currentLang }: MainDirectionsSectionProps) => {
  ...
  const directions: DirectionItem[] = [
    {
      id: 1, size: 'wide', accent: true,
      icon: <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>,
      title: { uz: 'Agromaslahatlar', ru: 'Агроконсультации', en: 'Agro-consulting' },
      desc: { uz: 'Mutaxassislarimizdan bepul maslahat oling', ru: 'Получите бесплатную консультацию наших специалистов', en: 'Get free consultation from our specialists' },
    ...
    },
    {
      ...
      title: { uz: 'Onlayn ariza', ru: 'Подать заявку онлайн', en: 'Online application' },
      desc: { uz: 'Arizani onlayn yuborish', ru: 'Подайте заявку не выходя из дома', en: 'Submit application from home' },
      href: '#application',
    },
  ]

          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            <div className="flex items-center space-x-1 sm:space-x-2 text-gray-700 min-w-0">
              ...
              <span className="font-medium truncate">
                ...
                <a href="tel:+998712067030" className="hover:text-primary-600 transition-colors whitespace-nowrap">71 206-70-30</a>
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  tabIndex={0}
                >
                  <span className="hidden sm:block">{social.icon}</span>
